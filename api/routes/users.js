...
//GETALL
// writing a query such that if a query is given only altest users have been given otherwise all users been given//
router.get("/", verify, async (req, res) => {
  ...
  if (req.user.isAdmin) {
    ...
    res.status(403).json("You are not allowed to see the info");
  }
});
//GET USER STATS
